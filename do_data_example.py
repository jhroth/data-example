...
## 1 feature
result_one_probe_null = qi.fitted_values(hypothesis="null", response_type="binary", X=best_probe_1d, Y=pcr, treatment=treatment, lam_control=optimal_lam_control_1d, lam_treat=optimal_lam_treat_1d, ggd_thresh=my_ggd_thresh, thresh=my_thresh, verbose=True)
result_one_probe_alt_control = qi.fitted_values(hypothesis="alternative", response_type="binary", X=best_probe_1d[ind_control], Y=pcr[ind_control], lam_alt=optimal_lam_control_1d, ggd_thresh=my_ggd_thresh, thresh=my_thresh, verbose=True)
result_one_probe_alt_treat = qi.fitted_values(hypothesis="alternative", response_type="binary", X=best_probe_1d[ind_treat], Y=pcr[ind_treat], lam_alt=optimal_lam_treat_1d, ggd_thresh=my_ggd_thresh, thresh=my_thresh, verbose=True)

## 2 features
result_two_probes_null = qi.fitted_values(hypothesis="null", response_type="binary", X=best_probes_2d, Y=pcr, treatment=treatment, lam_control=optimal_lam_control_2d, lam_treat=optimal_lam_treat_2d, ggd_thresh=my_ggd_thresh, thresh=my_thresh, verbose=True)
result_two_probes_alt_control = qi.fitted_values(hypothesis="alternative", response_type="binary", X=best_probes_2d[ind_control], Y=pcr[ind_control], lam_alt=optimal_lam_control_2d, ggd_thresh=my_ggd_thresh, thresh=my_thresh, verbose=True)
result_two_probes_alt_treat = qi.fitted_values(hypothesis="alternative", response_type="binary", X=best_probes_2d[ind_treat], Y=pcr[ind_treat], lam_alt=optimal_lam_treat_2d, ggd_thresh=my_ggd_thresh, thresh=my_thresh, verbose=True)
